						...
						<div class="cleaner col-md-12">
							...
							<div class="info cleaner">
								<div class="cleaner dates">
									<h2>Listo! Solo debes entrar a tu correo y ver tu contraseña. (No olvides verificar en bandeja de correos no deseados).</h2>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="container-fluid cleaner">					
					<div class="resumen cleaner maxspace">
						<div class="cleaner tobut">
							<button class="mybut but-style1 toanimated1" type="submit"><i class="icon-home animated"></i>&nbsp;Volver al inicio</button>
						</div>
					</div>
				</div>
			</div>
