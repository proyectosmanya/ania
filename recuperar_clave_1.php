						...
						<div class="cleaner col-md-12">
							...
							<div class="info cleaner">
								<div class="cleaner dates">
									<h2>No te preocupes, solo introduce el correo electrónico y recuperarás tu cuenta.</h2>
								</div>
							</div>
						</div>
					</div>
			...
			<div class="detalle-noticia cleaner">		
				<div class="container-fluid cleaner">					
					<div class="resumen cleaner maxspace">
						<form action="recuperar_clave_2.php" id="frm-login" class="cleaner">
								...
								<div class="row cleaner">
									...
									<div class="col-md-12 cleaner control-clone">
										<div class="cleaner tobut">
											<button class="mybut but-style1 toanimated1" type="submit"><i class="icon-user animated"></i>&nbsp;Recuperar mi cuenta</button>
										</div>														
									</div>
								</div>		
							</div>
